    ...
    <section class="checkout_page">
        ...
        <?php if (empty($cartItems)) : ?>
            <p class="text-center">Your cart is empty.
                <a href="pricing" style="color: var(--color-primary);">Go back to select a plan</a>
            </p>
        <?php else : ?>
            <div class="checkout_container">
                <?php foreach ($cartItems as $id => $price) : ?>
                    <form action="process_order.php" class="form" method="POST" novalidate>
                        <div>
                            <legend>Cart</legend>
                            <div class="card">
                                <address>
                        ...
                        <div>
                            <button type="submit" class="rts-btn btn-primary checkout_btn">
                                <svg class="icon">
